...
namespace RPGraph {
    class DatasetAdapter {
        public:
            DatasetAdapter(); // Initialize with dataset file.
            ...
            RPFileIterator get_file_iterator(std::string file_path); // Only return this once, subsequent calls should fail.
        private:
